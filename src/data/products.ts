/**
 * Données centralisées des 4 produits SaaS de FTCI.
 * Utilisé par Products.astro (page d'accueil), les pages produits dédiées,
 * le sitemap, et les données structurées schema.org.
 *
 * Pour ajouter/modifier un produit, éditer ce fichier uniquement.
 */
...
/** Map slug → product pour accès rapide */
...
/** URLs canoniques des pages produits (pour sitemap & schema.org) */
...
/** Mapping couleur → classes Tailwind pour les accents */
